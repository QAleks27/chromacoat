    ...
    >
      <Reveal>
        <span className="inline-flex items-center gap-2 rounded-full border border-border bg-background/70 px-3 py-1 text-xs font-medium text-muted-foreground backdrop-blur-sm">
          ...
          Oven-cured. Corrosion-proof. Built to outlast the metal.
        </span>
      </Reveal>
      ...
      <Reveal delay={160}>
        <p className="mt-7 max-w-xl text-lg leading-relaxed text-muted-foreground">
          Chroma Coat is a precision powder coating shop. We blast, coat, and
          cure your parts in thousands of colors and finishes — a bond that
          chips, fades, and rust never get through.
        </p>
      </Reveal>
      ...
      <Reveal delay={320}>
        <dl className="mt-16 grid max-w-lg grid-cols-3 gap-6 border-t border-border/70 pt-8">
          {[
            { n: "18k+", l: "parts coated" },
            { n: "6,000+", l: "colors on file" },
            { n: "72h", l: "average turnaround" },
          ].map((s) => (
            <div key={s.l}>
